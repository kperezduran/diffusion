...
class SaleReport(models.Model):
    ...
    seller_id = fields.Many2one(comodel_name='res.partner', string="Fournisseur", readonly=True)
    ...
    def _from_sale(self):
        return """
            ...
            LEFT JOIN LATERAL (
                ...
                WHERE psi_sub.product_tmpl_id = p.product_tmpl_id
                ORDER BY psi_sub.id DESC
                LIMIT 1
            ) AS psi ON TRUE
            LEFT JOIN res_partner rp ON psi.partner_id = rp.id
